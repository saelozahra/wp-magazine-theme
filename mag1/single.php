...
<figure itemtype="http://schema.org/ImageObject" itemscope="" itemprop="associatedMedia" class="post-thumbnail pt-zoom">
 ...
 <div class=" demo-gallery post_image">
<a href="<?php echo wp_get_attachment_url( get_post_thumbnail_id($post->ID) ) ?>" title="content"  data-author="<?php the_author(); ?>" data-size="<?php echo $image[width] ?>x<?php echo $image[height]; ?>" >
    ...
    <figure style="display:none;"><?php the_title(); ?></figure>
</a>
 
  </div><!--demo-gallery-->
  <div class="zire_image">
  	<div class="one_author">
		<?php echo get_avatar( get_the_author_meta( 'ID' ), 64 ); ?>
        <div class="author_name"><?php the_author(); ?></div><!--author_name-->
    </div><!--one_author-->
    <div class="two_comment">
		<a href="#comments"><i class="fa fa-comment-o"></i> <?php echo str_replace("دیدگاه","",str_replace("comment","", get_comments_number() )); ?></a>
    </div>
    ...
    <time class="three_date" itemprop="datePublished"> <?php the_time('M j/Y') ?> </time>
    
    
  </div>
  </div><!--post_image_frame-->
...
<div class="share-box ">
                    <h1 class="sec_head"><span class="red_border"></span> <?_e('Share This Post','Magazin1');?>  </h1>
