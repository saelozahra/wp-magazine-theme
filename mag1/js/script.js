...
$(".rmh5").click(function(){
	...
	if (parseInt($(this).attr("data-number")) == 3) {
		location.href = $(this).attr("data-href") ;
	} else {
		$("#recent_post_section .rp_outer ").height( $("#recent_post_section .rp_outer .rp_i").outerHeight() + $("#recent_post_section .rp_outer").height() + 19 );
